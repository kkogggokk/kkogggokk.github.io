...
<img src='https://raw.githubusercontent.com/kkogggokk/kkogggokk.github.io/master/assets/pic/post_20210212_pic1.png' width='100' height='100'>  

(2) 보의 한 쪽 끝 부분 위에 있거나       
왼쪽 보(x-1, y, 1) 가 있는 경우 기둥 설치 가능하다.
오른쪽 보(x, y, 1) 가 있는 경우 기둥 설치가 가능하다. 
<img src='https://raw.githubusercontent.com/kkogggokk/kkogggokk.github.io/master/assets/pic/post_20210212_pic2.png' width = '100' height = '100>
