...
![1차원, 2차원, 3차원 시각화](assets\img\post_20210216_numpy1.png)
...
a4 = np.array([10, 5.7])                # [10.   5.7], float64 다른 타입 저장  int float 타입 다른 타입 들어가게되면, flaot로 된다. 
a4 = np.array([10, 5.7, True])          # [10.   5.7  1. ], float64 True를 1.0으로 변환된다. 
a4 = np.array([10, 5.7, True, 'A'])     # ['10' '5.7' 'True' 'A'], <U32 , 'A'가 들어가면? 문자열로 바뀐다. ['10' '5.7' 'True' 'A']
print(a4)
print(a4.dtype) 
...
# 베열의 shape 확인 : 배열.shape => 튜플로 shape을 반환 
